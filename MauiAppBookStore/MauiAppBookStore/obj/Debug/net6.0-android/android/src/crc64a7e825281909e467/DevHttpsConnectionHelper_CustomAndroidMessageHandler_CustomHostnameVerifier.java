...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiAppBookStore.DevHttpsConnectionHelper+CustomAndroidMessageHandler+CustomHostnameVerifier, MauiAppBookStore", DevHttpsConnectionHelper_CustomAndroidMessageHandler_CustomHostnameVerifier.class, __md_methods);
	}
	...
	public DevHttpsConnectionHelper_CustomAndroidMessageHandler_CustomHostnameVerifier ()
	{
		...
		if (getClass () == DevHttpsConnectionHelper_CustomAndroidMessageHandler_CustomHostnameVerifier.class)
			mono.android.TypeManager.Activate ("MauiAppBookStore.DevHttpsConnectionHelper+CustomAndroidMessageHandler+CustomHostnameVerifier, MauiAppBookStore", "", this, new java.lang.Object[] {  });
	}
